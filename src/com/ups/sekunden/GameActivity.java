...
public class GameActivity extends Activity implements IRythmListener {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        //play musique
        backgroundMusic = MediaPlayer.create(this, SOUND_ID_HILIGHT_TRIBE_DRAGONFLY);
        backgroundMusic.setVolume(1, 1);
        backgroundMusic.setLooping(true);
        backgroundMusic.start(); // no need to call prepare(); create() does that for you
    ...
    public void doPause(View view){
        if (rythm.isPaused()) {
        	try {
                ...
                backgroundMusic.setVolume(0.333f, 0.333f); // setVolume (left, rigt) float values between 0 and 1
			...
			} catch (InterruptedException e) {} //caued thread.sleep
        }
        else {
            rythm.onPaused();
            diskImage.pause();
            ...
            } catch (InterruptedException e) { } //caused thread.sleep
        }
    }
}